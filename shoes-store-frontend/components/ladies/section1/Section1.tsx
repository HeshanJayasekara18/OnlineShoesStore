        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10 relative z-10">
            ...
            <div className="flex flex-wrap gap-4 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
              <button className="px-10 py-5 rounded-full bg-white text-black font-black uppercase tracking-widest hover:bg-pink-500 hover:text-white transition-all duration-500 shadow-2xl active:scale-95">
                Shop Now
              </button>
